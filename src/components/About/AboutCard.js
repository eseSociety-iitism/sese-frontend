                ...
                <section className="text-gray-600 body-font ">
                    <div className="mx-auto flex py-6 md:px-5 md:flex-row justify-center flex-col items-center">
                        <div className="md:max-w-sm lg:max-w-md md:h-full w-full h-48 overflow-hidden flex justify-center items-center mb-4 md:mb-0">
                            ...
                            <video className="w-full md:rounded-lg" alt="hero" src='/Video/ese (1).mp4' autoPlay muted loop />
                        </div>
...
<<<<<<< HEAD
                            <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">Established in 2003, SESE is one of the most acclaimed self-financed engineering colleges in West Bengal. It has been established by Ananda Educational Development & Charitable Organisation (AEDCO), <span className='font-bold'> a trust known for its deep sense of social commitment and dedicated to the promotion of education by inculcating appropriate ethics and attitude.</span></p>
=======
                            <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">Established in 2003, SESE is one of the most acclaimed self-financed society of IIT(ISM) Dhanbad in Jharkhand. It has been established by lorem epsum loreme epsummm
                            , <span className='font-bold'> a trust known for its deep sense of social commitment and dedicated to the promotion of education by inculcating appropriate ethics and attitude.</span></p>
>>>>>>> f1fd9f65a0fde53a0f3902b6e69dcca801ac3676
                        </div>
                    </div>
                </section>
...
<<<<<<< HEAD
                            <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">In a metamorphosis of over 18 years, SESE has been reinventing itself constantly to explore the infinite possibilities of engineering and technology – an academy that inspires everyone to think differently. It is now the preferred career destination for meritorious students due to its academic integrity and standard as well as its attractive campus placement.</p>
=======
                            <p className="mb-8 leading-relaxed font-medium text-sm sm:text-lg p-2">In a metamorphosis of over 18 years, SESE has been reinventing lorem ipsumlorem ipsumlorem ipsum technology – an academy that inspires everyone to think differently. It is now the preferred career lorem ipsumlorem ipsumlorem ipsumlorem ipsum to its academic integrity and standard as well as its attractive campus placement.</p>
>>>>>>> f1fd9f65a0fde53a0f3902b6e69dcca801ac3676
                        </div>
                    </div>
                </section>
